...
static void hnd_put_data(coap_resource_t *resource, coap_session_t *session COAP_UNUSED,
                         const coap_pdu_t *request, const coap_string_t *query COAP_UNUSED, coap_pdu_t *response) {
  size_t size;
  const uint8_t *data;
  coap_resource_notify_observers(resource, NULL);
...
>>>>>>> 6c6a540ca348f2d83d18c2772729d750fbe1926c
